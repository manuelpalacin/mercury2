		...
		<section>
			...
			<display:table id="tracerouteAS" name="tracerouteAS" pagesize="10" export="false" requestURI="/getLastTraceroutes" class="table table-condensed table-hover">
					...
					<display:column title="srcCity" sortable="true">
						<a href="getASTracerouteStatsByOriginCity?srcCity=<s:url value="%{#attr.tracerouteAS.srcCity}"/>&srcCountry=<s:url value="%{#attr.tracerouteAS.srcCountry}"/>" >
					...
					<display:column title="destination City" sortable="true" >
						<a href="getASTracerouteStatsByDestinationCity?dstCity=<s:url value="%{#attr.tracerouteAS.dstCity}"/>&dstCountry=<s:url value="%{#attr.tracerouteAS.dstCountry}"/>" >
